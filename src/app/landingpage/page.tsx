...
import { Globe, Box, Sparkles, Smartphone } from 'lucide-react';
...
import SecondHookSection from './components/SecondHookSection';
...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} className="flex flex-col relative test">
